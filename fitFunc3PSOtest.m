%% Testing PCCBPSO with fitFunc3
%By Rock Mason 2024
clear
close all
addpath C:\Users\cicad\Documents\GitHub\SDMBIGDAT19\CODES
% The fitness function called is fitFunc3. 
rmin = -30;% lower bound of search space coordinate
rmax = 30; %Upper bound of search space coordinate
ffparams = struct('rmin',rmin,...
                     'rmax',rmax ...
                  );
% Fitness function handle.
fitFuncHandle = @(x) fitFunc3(x,ffparams);
%%
% Call PSO.
rng('default')
